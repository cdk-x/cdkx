...
describe('Stack', () => {
  ...
  describe('Stack.of()', () => {
    ...
    it('throws if no stack is found in the tree', () => {
      ...
      expect(() => Stack.of(app)).toThrow('No Stack found in the construct tree');
    });
  });
  ...
  describe('artifactId', () => {
    it('is derived from node path with slashes replaced by dashes', () => {
      const app = makeApp();
      const stack = new Stack(app, 'my-stack', { provider: new TestProvider() });
    ...
    it('uses dashes for nested paths', () => {
      ...
      const child = new Stack(parent, 'child', { provider: new TestProvider() });
  ...
  describe('providerIdentifier', () => {
    it('delegates to provider.identifier', () => {
      const app = makeApp();
      const stack = new Stack(app, 'S', { provider: new TestProvider('my-provider') });
  ...
  describe('description', () => {
    ...
    it('stores the description when provided', () => {
      const app = makeApp();
      const stack = new Stack(app, 'S', { provider: new TestProvider(), description: 'my desc' });
  ...
  describe('synthesizer', () => {
    ...
    it('uses the overridden synthesizer when provided in props', () => {
      ...
      const stack = new Stack(app, 'S', { provider: new TestProvider(), synthesizer: mockSynth });
