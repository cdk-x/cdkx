...
const { status, data } = await apiInstance.detachServerIso(
    id
);
```
...
const { status, data } = await apiInstance.disableServerBackup(
    id
);
```
...
const { status, data } = await apiInstance.disableServerRescue(
    id
);
```
...
const { status, data } = await apiInstance.enableServerBackup(
    id
);
```
...
const { status, data } = await apiInstance.getServerAction(
    id,
    actionId
);
```
...
const { status, data } = await apiInstance.getServersAction(
    id
);
```
...
const { status, data } = await apiInstance.poweroffServer(
    id
);
```
...
const { status, data } = await apiInstance.poweronServer(
    id
);
```
...
const { status, data } = await apiInstance.rebootServer(
    id
);
```
...
const { status, data } = await apiInstance.removeServerFromPlacementGroup(
    id
);
```
...
const { status, data } = await apiInstance.requestServerConsole(
    id
);
```
...
const { status, data } = await apiInstance.resetServer(
    id
);
```
...
const { status, data } = await apiInstance.resetServerPassword(
    id
);
```
