...
------------ | ------------- | ------------- | -------------
**name** | **string** | New Placement Group name. | [optional] [default to undefined]
...
```typescript
import { UpdatePlacementGroupRequest } from '@cdkx-io/hetzner-sdk';

const instance: UpdatePlacementGroupRequest = {
    name,
    labels,
};
```
